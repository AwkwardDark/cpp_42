...
class PmergeMe
{
	...
	public:
		...
		bool 	is_sorted(std::vector<int> tabv, int begin, int step);
		int		get_max(std::vector<int> tabv, int idx, int end);
		...
		bool	is_sorted(std::deque<int> tabd, int begin, int step);
		int		get_max(std::deque<int> tabd, int idx, int end);
